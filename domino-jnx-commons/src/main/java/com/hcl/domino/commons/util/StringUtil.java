...
public class StringUtil {
	...
	/**
	 * Retrieves the first string from the input. If the input object is a {@link Collection},
	 * this is a stringified version of the first entry. Otherwise, it's a stringified version
	 * of the object itself.
	 * 
	 * @param val the object from which to extract the first string
	 * @return the first string, or {@code null} if the object is null or an empty collection
	 */
	public static String getFirstString(Object val) {
