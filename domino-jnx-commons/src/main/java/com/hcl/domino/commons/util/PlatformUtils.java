...
public class PlatformUtils {
	...
	static {
		String arch = DominoUtils.getJavaProperty("os.arch", null); //$NON-NLS-1$
		m_is64Bit = "xmd64".equals(arch) || "x86_64".equals(arch) || "amd64".equals(arch); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

		String osName = DominoUtils.getJavaProperty("os.name", ""); //$NON-NLS-1$ //$NON-NLS-2$
