...
public enum ReferenceType {
  ...
  static {
    for (final ReferenceType currType : ReferenceType.values()) {
      ReferenceType.typesByIntValue.put(currType.m_type, currType);
    }
  }

  public static ReferenceType getType(final int intVal) {
    final ReferenceType type = ReferenceType.typesByIntValue.get(intVal);
    if (type == null) {
