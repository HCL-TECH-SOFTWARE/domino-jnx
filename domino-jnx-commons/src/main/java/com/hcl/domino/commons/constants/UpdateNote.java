...
public enum UpdateNote implements INumberEnum<Integer>{
	...
	/** If before calling the above functions it is known that the deletion is soft, set this flag */
	DELETE_SOFT(0x08000000),
	
	/** If DBOPTBIT_DELETES_ARE_SOFT is set then this flag makes the deletion hard (old way) */
