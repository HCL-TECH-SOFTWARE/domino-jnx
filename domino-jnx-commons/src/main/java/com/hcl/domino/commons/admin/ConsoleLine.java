...
public class ConsoleLine implements IConsoleLine {
  ...
  public static ConsoleLine parseConsoleLine(final String encodedConsoleLine, final int srvType) {
    ...
    try {
      ...
      if (n4 > 0 && n5 > 0) {
        ...
        final int n6 = string3.indexOf(":", 0); //$NON-NLS-1$
        if (n6 > 0) {
  ...
  public String toString() {
    return MessageFormat.format(
        ...
        this.seqNum, this.timeStamp, this.execName, this.pid, this.tid, this.vTid, this.status, this.type, this.severity,
        this.color, this.addName,
        this.isPasswdReq, this.isPrompt, this.data);
  }
