...
public class CompositeComponentImpl extends AbstractNamedFileElement<CompositeComponent> implements CompositeComponent {

  public CompositeComponentImpl(Document doc) {
    super(doc);
  }
