...
public interface IOsErr extends IGlobalErr {
  ...
  short ERR_FAULT_RECOVERY_CRASHREPORTER = IGlobalErr.PKG_OS + 22;
  ...
  short ERR_OS_LAUNCHFAILMEM = IGlobalErr.PKG_OS + 188;
  @ErrorText(text = "Device is Busy/In Use")
  short ERR_BUSY = IGlobalErr.PKG_OS + 189;
  @ErrorText(text = "~notetmp.reg")
  short ERR_REGFILENAME = IGlobalErr.PKG_OS + 190;
  ...
  short ERR_NT_DC_NOT_FOUND = IGlobalErr.PKG_OS + 220;
  @ErrorText(text = "Netapi32.dll (Windows NT) or nadreg.dll (Windows 2000 or higher) could not be found.")
  short ERR_NT_DLL_NOT_FOUND = IGlobalErr.PKG_OS + 221;
  ...
  short ERR_FAULT_RECOVERY1 = IGlobalErr.PKG_OS + 239;
  ...
  short ERR_FAULT_RECOVERY2 = IGlobalErr.PKG_OS + 240;
  ...
  short ERR_FAULT_RECOVERY3 = IGlobalErr.PKG_OS + 241;
  @ErrorText(text = "ospipe read would block, pipe is empty.")
  short ERR_OSPIPE_READ_WOULDBLOCK = IGlobalErr.PKG_OS + 242 /* from 4.61 */;
  @ErrorText(text = "Invalid directory name or device not ready.")
  short ERR_BAD_DIRECTORY = IGlobalErr.PKG_OS + 243;
  @ErrorText(text = "Restart the server")
  short ERR_SERVER_RESTART = IGlobalErr.PKG_OS + 244;
  ...
  short ERR_SHMEM_NOT_FOUND = IGlobalErr.PKG_OS + 245;
  @ErrorText(text = "stack walk failed")
  short ERR_STACKWALK_FAILED = IGlobalErr.PKG_OS + 246;
  @ErrorText(text = "Folder is not empty")
  short ERR_DIR_NOT_EMPTY = IGlobalErr.PKG_OS + 247;
  @ErrorText(text = "This link points within the existing data directory tree")
  short ERR_CANNOT_LINK_TO_DATADIR = IGlobalErr.PKG_OS + 248;
  @ErrorText(text = "Destination path does not exist")
  short ERR_LINK_DEST_NO_EXIST = IGlobalErr.PKG_OS + 249;
  @ErrorText(text = "Insufficient memory.")
  short ERR_SERVER_MEMORY = IGlobalErr.PKG_OS + 250;
  @ErrorText(text = "(internal, used by message signal handler")
  short ERR_OSMESSAGE_IGNORE = IGlobalErr.PKG_OS + 251;
  @ErrorText(text = "(internal, used by message signal handler")
  short ERR_OSMESSAGE_ABORT = IGlobalErr.PKG_OS + 252;
  @ErrorText(text = "The specified path is invalid")
  short ERR_BAD_PATH = IGlobalErr.PKG_OS + 253;
  @ErrorText(text = "File is not a link")
  short ERR_FILE_NOT_LINK = IGlobalErr.PKG_OS + 255;
