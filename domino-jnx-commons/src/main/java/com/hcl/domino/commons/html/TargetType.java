...
public enum TargetType {
  ...
  static {
    for (final TargetType currType : TargetType.values()) {
      TargetType.typesByIntValue.put(currType.m_type, currType);
    }
  }

  public static TargetType getType(final int intVal) {
    final TargetType type = TargetType.typesByIntValue.get(intVal);
    if (type == null) {
