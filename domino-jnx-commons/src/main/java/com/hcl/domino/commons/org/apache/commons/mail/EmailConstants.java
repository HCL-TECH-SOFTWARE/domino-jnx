...
public final class EmailConstants {
  ...
  /**
   * Indicates if the STARTTLS command shall be used to initiate a TLS-secured
   * connection.
   *
   * @since 1.1
   */
  ...
  /**
   * Specifies the {@link javax.net.ssl.SSLSocketFactory} class to use to create
   * SMTP SSL sockets.
   *
   * @since 1.3
   */
  ...
  /**
   * Defines the default mime charset to use when none has been specified for the
   * message.
   *
   * @since 1.3.2
   */
