...
public interface IRegErr extends IGlobalErr {
  ...
  short ERR_REG_MAB_NO_ENCRYPT = IGlobalErr.PKG_REG + 148;
  ...
  short ERR_REG_LANG_TAG_MISSING_FROM_CERT = IGlobalErr.PKG_REG + 171;
  ...
  short ERR_REG_CERT_NOT_UPDATED = IGlobalErr.PKG_REG + 172;
  ...
  short ERR_REG_UPGRADENAMES = IGlobalErr.PKG_REG + 173;
  ...
  short ERR_REG_EVENTS4_SAVED = IGlobalErr.PKG_REG + 180;
  ...
  short ERR_REG_MULT_LANG_TAGS_MISSING = IGlobalErr.PKG_REG + 181;
  ...
  short ERR_REG_NOT_PRIMARY_DIRECTORY = IGlobalErr.PKG_REG + 182;
  @ErrorText(text = "Default server task %s will NOT be added to %s in NOTES.INI because %s is set.")
  short ERR_REG_SKIPPED_TASK = IGlobalErr.PKG_REG + 183;
  ...
  short ERR_REG_PERSONAL_SUBDIR_NOT_UNIQUE = IGlobalErr.PKG_REG + 184;
  ...
  short ERR_REG_PERSONAL_SUBDIR_NO_ACCESS = IGlobalErr.PKG_REG + 185;
  @ErrorText(text = "The registration roaming setting conflicts with the roaming policy setting for this user")
  short ERR_REG_ROAMING_CONFLICT = IGlobalErr.PKG_REG + 187;
  @ErrorText(text = "Entry contains no extended information")
  short ERR_REG_BTREE_NO_EXT_INFO = IGlobalErr.PKG_REG + 190;
  @ErrorText(text = "Cancel migration for all entries")
  short ERR_REG_CANCEL_ALL = IGlobalErr.PKG_REG + 191;
  ...
  short ERR_REG_WIN95_ENTRIES_LIMIT = IGlobalErr.PKG_REG + 192;
  @ErrorText(text = "Error upgrading the design of your Domino Directory.  Continue with server upgrade?")
  short ERR_REG_UPGRADENAMES_ERR = IGlobalErr.PKG_REG + 197;
  @ErrorText(text = "The internet address for this user is not unique.")
  short ERR_REG_INETADDR_NOT_UNIQUE = IGlobalErr.PKG_REG + 209;
  ...
  short ERR_REG_CERT_ALT_LANGUAGE_PROMPT = IGlobalErr.PKG_REG + 228;
  @ErrorText(text = "Registration failed:  A policy could not be retrieved from the Domino directory.")
  short ERR_REG_WITH_POLICY_FAILED = IGlobalErr.PKG_REG + 229;
  ...
  short ERR_REG_DUPLICATE_NAME = IGlobalErr.PKG_REG + 245;
  @ErrorText(text = "%a did not accept a name change")
  short STR_REG_LOG_NAME_REFUSED = IGlobalErr.PKG_REG + 246;
  ...
  short ERR_REG_CERTIFIER_NO_RECOVERY_INFO = IGlobalErr.PKG_REG + 255;
  @ErrorText(text = "Creating administration request to create mail file for %A...")
  short ERR_REG_CREATING_ADMINREQTOCREATE_MAILREPLICA = IGlobalErr.PKG_REG2 + 0;
  @ErrorText(text = "Creating mail file replica stub for %A...")
  short ERR_REG_CREATING_MAILREPLICA = IGlobalErr.PKG_REG2 + 1;
  @ErrorText(text = "Mail file replica stub(s) for %A could not be created")
  short ERR_REG_NO_MAILREPLICAS_CREATED = IGlobalErr.PKG_REG2 + 2;
  @ErrorText(text = "Creation of the mail or roaming file replica stub '%A' failed with the following error:  %s")
  short ERR_REG_USER_FILE_REPLICATION = IGlobalErr.PKG_REG2 + 3;
  ...
  short ERR_REG_ORG_STORAGE_NOT_UNIQUE = IGlobalErr.PKG_REG2 + 11;
  ...
  short ERR_REG_POLICY_HOSTING_SERVER_NEEDED = IGlobalErr.PKG_REG2 + 12;
  ...
  short ERR_REG_POLICY_PASSWORD_QUALITY_NEEDED = IGlobalErr.PKG_REG2 + 13;
  ...
  short ERR_REG_POLICY_INTERNET_PASSWORD_NEEDED = IGlobalErr.PKG_REG2 + 14;
  ...
  short ERR_REG_POLICY_DOLS_SERVER_NEEDED = IGlobalErr.PKG_REG2 + 15;
  ...
  short ERR_REG_POLICY_ID_CREATION_NEEDED = IGlobalErr.PKG_REG2 + 16;
  ...
  short ERR_REG_POLICY_SIGNER = IGlobalErr.PKG_REG2 + 71;
