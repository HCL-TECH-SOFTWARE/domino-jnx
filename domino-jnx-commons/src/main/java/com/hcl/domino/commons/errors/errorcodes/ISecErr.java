...
public interface ISecErr extends IGlobalErr {
  ...
  short ERR_SECURE_CHANGE_WRONG_NEW_NAME = IGlobalErr.PKG_SECURE + 134;
  ...
  short ERR_SECURE_CROSS_CERT_NOT_ALLOWED = IGlobalErr.PKG_SECURE + 135;
  ...
  short ERR_SECURE_UPGRADE_ONLY = IGlobalErr.PKG_SECURE + 143;
  @ErrorText(text = "The new name specified in the Name Change Request is not a hierarchical name")
  short ERR_SECURE_CHANGE_MUST_BE_HI = IGlobalErr.PKG_SECURE + 144;
  ...
  short ERR_SECURE_WRONG_NEWABPI = IGlobalErr.PKG_SECURE + 196;
  ...
  short ERR_SECURE_PASS_NOT_SAME = IGlobalErr.PKG_SECURE + 236;
  ...
  short ERR_SECURE_NT_RELOGON = IGlobalErr.PKG_SECURE + 237;
  ...
  short ERR_SECURE_UNSYNCED_PASSWORD = IGlobalErr.PKG_SECURE + 238;
  ...
  short ERR_SECURE_NAME_IN_SIGNED_DOCS = IGlobalErr.PKG_SECURE + 239;
  @ErrorText(text = "The server you are trying to access requires that your ID file have a single password")
  short ERR_SECURE_NO_MULTIPW = IGlobalErr.PKG_SECURE + 240;
  @ErrorText(text = "WARNING: Your password will expire on ")
  short ERR_SECURE_PWD_TO_EXPIRE = IGlobalErr.PKG_SECURE + 241;
  @ErrorText(text = "You must change your password. It expired on ")
  short ERR_SECURE_PWD_EXPIRED = IGlobalErr.PKG_SECURE + 242;
  ...
  short ERR_SECURE_BAD_TEMPLATE_KEY = IGlobalErr.PKG_SECURE + 246;
