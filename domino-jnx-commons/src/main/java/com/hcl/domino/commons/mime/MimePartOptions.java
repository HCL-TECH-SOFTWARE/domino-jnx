...
public enum MimePartOptions {
  ...
  public static short toBitMask(final EnumSet<MimePartOptions> findSet) {
    int result = 0;
    if (findSet != null) {
      for (final MimePartOptions currFind : MimePartOptions.values()) {
  ...
  public static int toBitMaskInt(final EnumSet<MimePartOptions> findSet) {
    int result = 0;
    if (findSet != null) {
      for (final MimePartOptions currFind : MimePartOptions.values()) {
        if (findSet.contains(currFind)) {
