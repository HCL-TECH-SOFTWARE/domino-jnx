...
public interface IDocumentSummary {
	...
	/**
	 * Convenience function that converts a summary value to a {@link DominoDateTime}
	 * 
	 * @param itemName item name, case insensitive
	 * @param defaultValue default value if column is empty or is not a DominoDateTime
	...
	/**
	 * Convenience function that converts a summary value to a {@link DominoDateTime} list
	 * 
	 * @param itemName item name, case insensitive
	 * @param defaultValue default value if column is empty or is not a DominoDateTime list
