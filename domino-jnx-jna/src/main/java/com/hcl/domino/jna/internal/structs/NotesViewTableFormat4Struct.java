...
public class NotesViewTableFormat4Struct extends BaseStructure {
	...
	public static NotesViewTableFormat4Struct newInstance() {
		return AccessController.doPrivileged((PrivilegedAction<NotesViewTableFormat4Struct>) () -> new NotesViewTableFormat4Struct());
	}
	...
	public static NotesViewTableFormat4Struct newInstance(final short Length, final int Flags, final short RepeatType) {
		return AccessController.doPrivileged((PrivilegedAction<NotesViewTableFormat4Struct>) () -> new NotesViewTableFormat4Struct(Length, Flags, RepeatType));
	}
	...
	public static NotesViewTableFormat4Struct newInstance(final Pointer peer) {
		return AccessController.doPrivileged((PrivilegedAction<NotesViewTableFormat4Struct>) () -> new NotesViewTableFormat4Struct(peer));
	}
