 ...
 */
public class NotesResultsSortColumnV1201 extends Structure {
	/**
	...
	public NotesResultsSortColumnV1201() {
		super();
	}
	...
	public NotesResultsSortColumnV1201(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends NotesResultsSortColumnV1201 implements Structure.ByReference {
		
	};
	public static class ByValue extends NotesResultsSortColumnV1201 implements Structure.ByValue {
		
	};
	
	 public static NotesResultsSortColumnV1201 newInstance() {
	    return AccessController.doPrivileged((PrivilegedAction<NotesResultsSortColumnV1201>) () -> {
	      return new NotesResultsSortColumnV1201();
	    });
	  }
