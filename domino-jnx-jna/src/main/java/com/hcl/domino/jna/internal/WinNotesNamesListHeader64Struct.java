...
public class WinNotesNamesListHeader64Struct extends BaseStructure {
	...
	public static WinNotesNamesListHeader64Struct newInstance() {
		return AccessController.doPrivileged((PrivilegedAction<WinNotesNamesListHeader64Struct>) () -> new WinNotesNamesListHeader64Struct());
	}
	...
	public static WinNotesNamesListHeader64Struct newInstance(final short numNames, final byte id[], final byte product, final byte check[], final short authenticated) {
		return AccessController.doPrivileged((PrivilegedAction<WinNotesNamesListHeader64Struct>) () -> new WinNotesNamesListHeader64Struct(numNames, id, product, check, authenticated));
	}
	...
	public static WinNotesNamesListHeader64Struct newInstance(final Pointer p) {
		return AccessController.doPrivileged((PrivilegedAction<WinNotesNamesListHeader64Struct>) () -> new WinNotesNamesListHeader64Struct(p));
	}
