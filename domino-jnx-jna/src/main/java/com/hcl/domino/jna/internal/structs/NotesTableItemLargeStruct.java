...
public class NotesTableItemLargeStruct extends BaseStructure {
	...
	public static NotesTableItemLargeStruct newInstance() {
		return AccessController.doPrivileged((PrivilegedAction<NotesTableItemLargeStruct>) () -> new NotesTableItemLargeStruct());
	}
	 ...
	 * @param filler can't have padding for inplace ods -> host<br>
	...
	public static NotesTableItemLargeStruct newInstance(Pointer peer) {
		return AccessController.doPrivileged((PrivilegedAction<NotesTableItemLargeStruct>) () -> new NotesTableItemLargeStruct(peer));
	}
	...
	public static NotesTableItemLargeStruct.ByReference newInstanceByReference() {
		return AccessController.doPrivileged((PrivilegedAction<NotesTableItemLargeStruct.ByReference>) () -> new NotesTableItemLargeStruct.ByReference());
	}
