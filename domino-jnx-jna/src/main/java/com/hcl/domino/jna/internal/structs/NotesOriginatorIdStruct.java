...
public class NotesOriginatorIdStruct extends BaseStructure implements IAdaptable {
	...
	public static NotesOriginatorIdStruct newInstance() {
		return AccessController.doPrivileged((PrivilegedAction<NotesOriginatorIdStruct>) () -> new NotesOriginatorIdStruct());
	}
	...
	public static NotesOriginatorIdStruct newInstance(final NotesTimeDateStruct File, final NotesTimeDateStruct Note, final int Sequence, final NotesTimeDateStruct SequenceTime) {
		return AccessController.doPrivileged((PrivilegedAction<NotesOriginatorIdStruct>) () -> new NotesOriginatorIdStruct(File, Note, Sequence, SequenceTime));
	}
	...
	public static NotesOriginatorIdStruct newInstance(final NotesUniversalNoteIdStruct unid, final int Sequence, final NotesTimeDateStruct SequenceTime) {
		return AccessController.doPrivileged((PrivilegedAction<NotesOriginatorIdStruct>) () -> new NotesOriginatorIdStruct(unid, Sequence, SequenceTime));
	}
	...
	public static NotesOriginatorIdStruct newInstance(final Pointer p) {
		return AccessController.doPrivileged((PrivilegedAction<NotesOriginatorIdStruct>) () -> new NotesOriginatorIdStruct(p));
	}
	...
	public NotesUniversalNoteIdStruct getUNID() {
		return NotesUniversalNoteIdStruct.newInstance(this.File, this.Note);
	}
	...
	public String getUNIDAsString() {
		...
		formatter.format("%016x", data.getLong()); //$NON-NLS-1$
		String unid = formatter.toString().replace(" ", "0").toUpperCase(); //$NON-NLS-1$ //$NON-NLS-2$
		formatter.close();
		return unid;
	}
	...
	public void setUNID(String unid) {
		if (unid.length()!=32) {
			throw new IllegalArgumentException(MessageFormat.format("Invalid unid: {0}", unid));
		}
