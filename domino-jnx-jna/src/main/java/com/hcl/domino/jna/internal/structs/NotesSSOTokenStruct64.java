 ...
 */
public class NotesSSOTokenStruct64 extends BaseStructure implements ISSOTokenStruct {
	public int mhName;
	...
	public static NotesSSOTokenStruct64 newInstance() {
		return AccessController.doPrivileged((PrivilegedAction<NotesSSOTokenStruct64>) () -> new NotesSSOTokenStruct64());
	}
	...
	public static NotesSSOTokenStruct64 newInstance(final int mhName, final int mhDomainList, final short wNumDomains, final int bSecureOnly, final int mhData) {
		return AccessController.doPrivileged((PrivilegedAction<NotesSSOTokenStruct64>) () -> new NotesSSOTokenStruct64(mhName, mhDomainList, wNumDomains, bSecureOnly, mhData));
	}
	...
	public static NotesSSOTokenStruct64 newInstance(final Pointer p) {
		return AccessController.doPrivileged((PrivilegedAction<NotesSSOTokenStruct64>) () -> new NotesSSOTokenStruct64(p));
	}
