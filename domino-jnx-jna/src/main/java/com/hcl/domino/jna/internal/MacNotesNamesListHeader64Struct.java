...
public class MacNotesNamesListHeader64Struct extends BaseStructure {
	...
	public static MacNotesNamesListHeader64Struct newInstance() {
		return AccessController.doPrivileged((PrivilegedAction<MacNotesNamesListHeader64Struct>) () -> new MacNotesNamesListHeader64Struct());
	}
	...
	public static MacNotesNamesListHeader64Struct newInstance(final short numNames, final byte id[], final byte product, final byte check[], final short authenticated) {
		return AccessController.doPrivileged((PrivilegedAction<MacNotesNamesListHeader64Struct>) () -> new MacNotesNamesListHeader64Struct(numNames, id, product, check, authenticated));
	}
	...
	public static MacNotesNamesListHeader64Struct newInstance(final Pointer peer) {
		return AccessController.doPrivileged((PrivilegedAction<MacNotesNamesListHeader64Struct>) () -> new MacNotesNamesListHeader64Struct(peer));
	}
