...
/**
 * The {@link DominoIntlFormat} is used to declare a data structure with country and workstation dependant information.<br>
 * <br>
 * This structure provides information useful in parsing or composing Time, Date, and Currency strings.<br>
 * <br>
 * It is also used by {@code JNADominoDateTime#toString(DominoIntlFormat, com.mindoo.domino.jna.constants.DateFormat, com.mindoo.domino.jna.constants.TimeFormat, com.mindoo.domino.jna.constants.ZoneFormat, com.mindoo.domino.jna.constants.DateTimeStructure)}
 * to indicate the expected or resulting string format, current time zone and daylight savings values.<br>
 * <br>
 * Note: The function {@code JNADominoDateTime#toString(DominoIntlFormat, com.mindoo.domino.jna.constants.DateFormat, com.mindoo.domino.jna.constants.TimeFormat, com.mindoo.domino.jna.constants.ZoneFormat, com.mindoo.domino.jna.constants.DateTimeStructure)}
 * does not take the DAYLIGHT_SAVINGS ({@link #setDST(boolean)}) flag into account.

 * @author Karsten Lehmann
 */
public class DominoIntlFormat implements IAdaptable {
	 ...
	 */
	public DominoIntlFormat(IAdaptable adaptable) {
	 ...
	 */
	public DominoIntlFormat() {
		m_struct = IntlFormatStruct.newInstance();
		NotesCAPI.get().OSGetIntlSettings(m_struct, (short) (JNANotesConstants.intlFormatSize & 0xffff));
		m_struct.read();
	}
	...
	public int getCurrencyDigits() {
		return m_struct.CurrencyDigits & 0xff;
	}
