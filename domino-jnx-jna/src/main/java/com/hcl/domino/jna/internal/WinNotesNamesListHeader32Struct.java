...
public class WinNotesNamesListHeader32Struct extends BaseStructure {
	...
	public static WinNotesNamesListHeader32Struct newInstance() {
		return AccessController.doPrivileged((PrivilegedAction<WinNotesNamesListHeader32Struct>) () -> new WinNotesNamesListHeader32Struct());
	}
	...
	public static WinNotesNamesListHeader32Struct newInstance(final short numNames, final byte id[], final byte product, final byte check[], final short authenticated) {
		return AccessController.doPrivileged((PrivilegedAction<WinNotesNamesListHeader32Struct>) () -> new WinNotesNamesListHeader32Struct(numNames, id, product, check, authenticated));
	}
	...
	public static WinNotesNamesListHeader32Struct newInstance(final Pointer p) {
		return AccessController.doPrivileged((PrivilegedAction<WinNotesNamesListHeader32Struct>) () -> new WinNotesNamesListHeader32Struct(p));
	}
