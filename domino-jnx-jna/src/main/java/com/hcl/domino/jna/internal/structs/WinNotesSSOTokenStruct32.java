 ...
 */
public class WinNotesSSOTokenStruct32 extends BaseStructure implements ISSOTokenStruct {
	public int mhName;
	...
	public static WinNotesSSOTokenStruct32 newInstance() {
		return AccessController.doPrivileged((PrivilegedAction<WinNotesSSOTokenStruct32>) () -> new WinNotesSSOTokenStruct32());
	}
	...
	public static WinNotesSSOTokenStruct32 newInstance(final int mhName, final int mhDomainList, final short wNumDomains, final boolean bSecureOnly, final int mhData) {
		return AccessController.doPrivileged((PrivilegedAction<WinNotesSSOTokenStruct32>) () -> new WinNotesSSOTokenStruct32(mhName, mhDomainList, wNumDomains, bSecureOnly, mhData));
	}
	...
	public static WinNotesSSOTokenStruct32 newInstance(final Pointer p) {
		return AccessController.doPrivileged((PrivilegedAction<WinNotesSSOTokenStruct32>) () -> new WinNotesSSOTokenStruct32(p));
	}
