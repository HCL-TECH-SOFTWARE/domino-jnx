 ...
 */
public class WinNotesSSOTokenStruct64 extends BaseStructure implements ISSOTokenStruct {
	public int mhName;
	...
	public static WinNotesSSOTokenStruct64 newInstance() {
		return AccessController.doPrivileged((PrivilegedAction<WinNotesSSOTokenStruct64>) () -> new WinNotesSSOTokenStruct64());
	}
	...
	public static WinNotesSSOTokenStruct64 newInstance(final int mhName, final int mhDomainList, final short wNumDomains, final boolean bSecureOnly, final int mhData) {
		return AccessController.doPrivileged((PrivilegedAction<WinNotesSSOTokenStruct64>) () -> new WinNotesSSOTokenStruct64(mhName, mhDomainList, wNumDomains, bSecureOnly, mhData));
	}
	...
	public static WinNotesSSOTokenStruct64 newInstance(final Pointer p) {
		return AccessController.doPrivileged((PrivilegedAction<WinNotesSSOTokenStruct64>) () -> new WinNotesSSOTokenStruct64(p));
	}
