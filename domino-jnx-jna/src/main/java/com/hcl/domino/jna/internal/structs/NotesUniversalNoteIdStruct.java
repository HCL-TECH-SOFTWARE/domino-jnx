...
public class NotesUniversalNoteIdStruct extends BaseStructure implements IAdaptable {
	...
	public static NotesUniversalNoteIdStruct newInstance() {
		return AccessController.doPrivileged((PrivilegedAction<NotesUniversalNoteIdStruct>) () -> new NotesUniversalNoteIdStruct());
	}
	...
	public static NotesUniversalNoteIdStruct newInstance(final NotesTimeDateStruct File, final NotesTimeDateStruct Note) {
		return AccessController.doPrivileged((PrivilegedAction<NotesUniversalNoteIdStruct>) () -> new NotesUniversalNoteIdStruct(File, Note));
	}
	...
	public static NotesUniversalNoteIdStruct newInstance(final Pointer p) {
		return AccessController.doPrivileged((PrivilegedAction<NotesUniversalNoteIdStruct>) () -> new NotesUniversalNoteIdStruct(p));
	}
	
	public static NotesUniversalNoteIdStruct.ByReference newInstanceByReference() {
		return AccessController.doPrivileged((PrivilegedAction<ByReference>) () -> new NotesUniversalNoteIdStruct.ByReference());
	}
	...
	public static class ByValue extends NotesUniversalNoteIdStruct implements Structure.ByValue {
		public static NotesUniversalNoteIdStruct.ByValue newInstance() {
			return AccessController.doPrivileged((PrivilegedAction<ByValue>) () -> new NotesUniversalNoteIdStruct.ByValue());
		}
	};
