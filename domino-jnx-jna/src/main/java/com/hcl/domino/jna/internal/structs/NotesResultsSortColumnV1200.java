 ...
 */
public class NotesResultsSortColumnV1200 extends BaseStructure {
	/**
	...
	public NotesResultsSortColumnV1200() {
		super();
	}
	...
	public static NotesResultsSortColumnV1200 newInstance() {
		return AccessController.doPrivileged((PrivilegedAction<NotesResultsSortColumnV1200>) () -> {
			return new NotesResultsSortColumnV1200();
		});
	}
  ...
  protected List<String> getFieldOrder() {
	...
	public NotesResultsSortColumnV1200(Pointer peer) {
		super(peer);
	}
	
	public static NotesResultsSortColumnV1200 newInstance(Pointer peer) {
		return AccessController.doPrivileged((PrivilegedAction<NotesResultsSortColumnV1200>) () -> {
			return new NotesResultsSortColumnV1200(peer);
		});
	}

	public static NotesResultsSortColumnV1200.ByReference newInstanceByReference() {
		return AccessController.doPrivileged((PrivilegedAction<NotesResultsSortColumnV1200.ByReference>) () -> {
			return new NotesResultsSortColumnV1200.ByReference();
		});
	}

	public static class ByReference extends NotesResultsSortColumnV1200 implements Structure.ByReference {
		public ByReference() {
			super();
		}
	};
	public static class ByValue extends NotesResultsSortColumnV1200 implements Structure.ByValue {
