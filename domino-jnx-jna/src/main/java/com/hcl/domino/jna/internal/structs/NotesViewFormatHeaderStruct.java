...
public class NotesViewFormatHeaderStruct extends BaseStructure {
	...
	public static NotesViewFormatHeaderStruct newInstance() {
		return AccessController.doPrivileged((PrivilegedAction<NotesViewFormatHeaderStruct>) () -> new NotesViewFormatHeaderStruct());
	}

	@Override
	protected List<String> getFieldOrder() {
		return Arrays.asList("Version", "ViewStyle"); //$NON-NLS-1$ //$NON-NLS-2$
	}
	/**
	...
	public static NotesViewFormatHeaderStruct newInstance(final byte Version, final byte ViewStyle) {
		return AccessController.doPrivileged((PrivilegedAction<NotesViewFormatHeaderStruct>) () -> new NotesViewFormatHeaderStruct(Version, ViewStyle));
	}
	...
	public static NotesViewFormatHeaderStruct newInstance(final Pointer peer) {
		return AccessController.doPrivileged((PrivilegedAction<NotesViewFormatHeaderStruct>) () -> new NotesViewFormatHeaderStruct(peer));
	}
