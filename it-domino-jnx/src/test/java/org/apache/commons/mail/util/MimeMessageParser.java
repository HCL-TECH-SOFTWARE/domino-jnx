...
public class MimeMessageParser
{
    ...
    {
        if (isMimeType(part, "text/plain") && plainContent == null //$NON-NLS-1$
        ...
        {
            if (isMimeType(part, "text/html") && htmlContent == null //$NON-NLS-1$
                    && !Part.ATTACHMENT.equalsIgnoreCase(part.getDisposition()))
            {
            ...
            {
                if (isMimeType(part, "multipart/*")) //$NON-NLS-1$
                {
