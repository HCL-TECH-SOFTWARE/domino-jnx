...
public interface MimeHeader {
   ...
   * <p>
   * In practice, this map acts similarly to a {@link java.util.LinkedHashMap
   * LinkedHashMap}
   * in that parameters will be written in the header in the order that they're
   * added.
   * </p>
   *
   ...
   * <p>
   * Calling this method invalidates any objects returned by
   * {@link #getParameters()}.
   * </p>
   *
