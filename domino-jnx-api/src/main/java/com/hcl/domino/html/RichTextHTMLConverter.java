...
public interface RichTextHTMLConverter {
	...
	public interface Builder {
		/**
		 * Sets an HTML conversion option based on the {@link HtmlConvertOption} enumeration.
		 * 
		...
		/**
		 * Sets multiple HTML conversion option based on the {@link HtmlConvertOption} enumeration.
		 * 
		 ...
		 * 
		 * <p>Note: these options must be {@code "key=value"} pairs. To use {@link HtmlConvertOption}
		 * values, use the {@link HtmlConvertOption#toOption(String)} method.</p>
		 * 
