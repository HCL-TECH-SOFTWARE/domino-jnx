...
public interface OutOfOffice {
	public enum OOOType {AGENT, SERVICE}
	 ...
	 * If this flag is set to {@code true} OOO notifications will not be generated for
	 * email originating from the internet. The default for this flag is {@code true}.
	 * 
	 ...
	 * If {@link #getState(Ref, Ref)} is called immediately following {@link #setEnabled(boolean)} it will
	 ...
	 * {@link Person#openOutOfOffice(String, boolean, Database)},
	 * {@link #setAwayPeriod(TemporalAccessor, TemporalAccessor)}, and {@link #setEnabled(boolean)}.<br>
	 * <br>
	 * When you need to enable OOO (i.e. call it with <code>enabled</code> flag set to {@code true})
	 * you should call {@link #setAwayPeriod(TemporalAccessor, TemporalAccessor)} prior to calling
	 ...
	 * to {@code true}) you should call {@link #setAwayPeriod(TemporalAccessor, TemporalAccessor)}
	 ...
	 * When you need to disable OOO (i.e. call it with <code>enabled</code> set to {@code false})
	 * {@link #setAwayPeriod(TemporalAccessor, TemporalAccessor)} does not need to be called.<br>
	 * <br>
