...
public interface DominoRuntime {
	 ...
	 * 
	 * @return an {@link Optional} describing a {@link Path} representing the data directory
	 *      on the filesystem, or an empty one if the directory cannot be determined
	 */
	 ...
	 * 
	 * @return an {@link Optional} describing a {@link Path} representing the program directory
	 *      on the filesystem, or an empty one if the directory cannot be determined
	 */
	 ...
	 * 
	 * @return an {@link Optional} describing a {@link Path} representing the temp directory
	 *      on the filesystem, or an empty one if the directory cannot be determined
	 */
	 ...
	 * 
	 * @return an {@link Optional} describing a {@link Path} representing the view-rebuild directory
	 *      on the filesystem, or an empty one if the directory cannot be determined
	 */
	 ...
	 * 
	 * <p>These properties correspond to notes.ini settings.</p>
	 * 
