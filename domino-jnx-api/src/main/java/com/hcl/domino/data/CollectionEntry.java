...
public interface CollectionEntry extends TypedAccess, IndexedTypedAccess, Map<String,Object>, IAdaptable {
	 ...
	 * 
	 * @return the UNID of the entry's document, or an all-zero string if is not a document
	 */
	String getUNID();
	 ...
	 * 
	 * @return an {@link Optional} describing the document associated with this entry, or
	 ...
	 * 
	 * @return a {@link Optional} describing this {@link DocumentClass} for the entry, or
