...
public interface AdministrationProcess extends DominoClientDescendant {
	 ...
	 * 
	 * @param username The full hierarchical name (can be abbreviated) of the user.
	 * @param oldpassword The existing password
	 * @param newpassword The new password
	 * @return note id The note ID of an entry created in the Administration Requests database
	 */
...
//
//	String createReplica(String sourceserver, String sourcedbfile, String destserver);
...
//	String deleteUser(
//			String username, boolean immediate, 
//			int mailfileaction, String denygroup, boolean deletewindowsuser, int idvaultaction);
//
//
...
//
//	String moveReplica( String sourceserver, String sourcedbfile, String destserver);
//	String moveReplica(
//			String sourceserver, String sourcedbfile,
//			String destserver, String destdbfile,
//			boolean copyacl, boolean createftindex);
//
//	String moveRoamingUser(String username, String destserver, String destserverpath);
//
...
//	String signDatabaseWithServerID( String server, String dbfile, boolean updateonly);
//
...
//	String delegateMailFile(String mailfileowner, Collection<String> publicreaders, Collection<String> publicwriters,
//			Collection<String> otherreaders, Collection<String> otherwriters, Collection<String> othereditors,
