...
public interface IdVault {
  ...
  public interface IDAccessCallback<T> {
    ...
    /**
     * Implement this method to work with the passed user id. <b>Do not store it
     * anywhere, since it is disposed right after the method call!</b>.
     *
     * @param id id
