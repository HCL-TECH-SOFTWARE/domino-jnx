 ...
 * <br>
 * NOTE: Please note the distinction between {@link ReplicationFlags#DISABLE}
 * and
 * {@link ReplicationFlags#NEVER_REPLICATE}. The former is used to temporarily
 * disable
...
public enum ReplicationFlags implements INumberEnum<Short> {
  ...
  ReplicationFlags(final Short value) {
    this.m_value = value;
  }
