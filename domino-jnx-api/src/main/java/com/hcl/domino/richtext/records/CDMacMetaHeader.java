...
/**
 * Rich text record of type CDMACMETAHEADER (editods.h)
 * 
 * @since 1.0.45
 */
@StructureDefinition(
  name = "CDMACMETAHEADER",
  members = {
...
public interface CDMacMetaHeader extends RichTextRecord<LSIG> {
  ...
  CDMacMetaHeader setMetafileSize(long metafileSize);
  
  @StructureGetter("SegCount")
  int getSegCount();
  
  @StructureSetter("SegCount")
  CDMacMetaHeader setSegCount(int segCount);
}
