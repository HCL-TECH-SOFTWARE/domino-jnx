...
public interface CDAnchor extends RichTextRecord<WSIG> {
  ...
  CDAnchor setDataLength(int len);
  
  default String getAnchorText() {
  ...
  default CDAnchor setAnchorText(String text) {
