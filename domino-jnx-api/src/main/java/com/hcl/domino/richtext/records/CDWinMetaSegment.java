...
/**
 * Rich text record of type CDWINMETASEG
 */
@StructureDefinition(name = "CDWINMETASEG", members = {
...
public interface CDWinMetaSegment extends RichTextRecord<LSIG> {
  ...
  CDWinMetaSegment setDataSize(int length);
  
  @StructureGetter("SegSize")
  int getSegSize();
  
  @StructureSetter("SegSize")
  CDWinMetaSegment setSegSize(int xExt);
}
