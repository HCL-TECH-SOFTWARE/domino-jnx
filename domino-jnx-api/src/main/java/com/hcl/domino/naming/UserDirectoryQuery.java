...
public interface UserDirectoryQuery extends SearchQuery {
   ...
   * </p>
   *
   * @return a {@link Stream} of {@code List<Map<String, Object>>} lookup results
   *         for this query
   * @throws IllegalArgumentException if {@link #items(Collection)} has not been
   *                                  specified or if
   *                                  either it or {@link #namespaces(Collection)}
   *                                  is set to {@code null} or empty
   */
