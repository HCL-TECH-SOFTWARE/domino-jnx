...
public interface Schedule extends IAdaptable {
	 ...
	 * 
	 * @return an {@link Optional} describing the lower bound, or an empty one if this
	 * is not available
	 */
	 ...
	 * 
	 * @return an {@link Optional} describing the upper bound, or an empty one if this
	 * is not available
	 */
	 ...
	 * 
	 * @return an {@link Optional} describing the loading exception, or an empty one if
	 *      there was no error
	 */
