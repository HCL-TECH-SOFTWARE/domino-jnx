...
public interface JsonDeserializer {
	 ...
	 * @throws IllegalStateException if there is no registered deserializer implementation
	 */
	 ...
	 * 
	 * <p>Documents imported this way will be returned unsaved in memory.</p>
	 * 
	 ...
	 * 
	 * <p>Documents imported this way will be modified in-place in memory but not saved.</p>
	 * 
	 ...
	 * 
	 * <p>The {@code "Form"} item and items beginning with {@code "$"} will never be removed
	 * in this way.</p>
	 * 
	...
	/**
	 * Specifies a custom processor for a named property. Calling this method will delegate handling of
	 * the named property on the incoming JSON to the processor object.
	 * 
	 * @param propName the name of the property to process
	 * @param processor a {@link CustomProcessor} functional object to apply when the named property is encountered
	 * @return this deserializer
	 * @since 1.0.28
	 ...
	 * @throws RuntimeException an implementation-specific exception when the JSON is unprocessable
	 * 		as configured
	 */
