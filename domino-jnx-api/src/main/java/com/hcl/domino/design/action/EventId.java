...
public enum EventId implements INumberEnum<Short> {
  ...
  CLIENT_VIEW_QUERYOPEN(RichTextConstants.HTML_EVENT_CLIENT_VIEW_QUERYOPEN),
  CLIENT_VIEW_POSTOPEN(RichTextConstants.HTML_EVENT_CLIENT_VIEW_POSTOPEN),
  CLIENT_VIEW_REGIONDBLCLK(RichTextConstants.HTML_EVENT_CLIENT_VIEW_REGIONDBLCLK),
  CLIENT_VIEW_QUERYOPENDOC(RichTextConstants.HTML_EVENT_CLIENT_VIEW_QUERYOPENDOC),
  CLIENT_VIEW_QUERYRECALC(RichTextConstants.HTML_EVENT_CLIENT_VIEW_QUERYRECALC),
  CLIENT_VIEW_QUERYADDTOFOLDER(RichTextConstants.HTML_EVENT_CLIENT_VIEW_QUERYADDTOFOLDER),
  CLIENT_VIEW_QUERYPASTE(RichTextConstants.HTML_EVENT_CLIENT_VIEW_QUERYPASTE),
  CLIENT_VIEW_POSTPASTE(RichTextConstants.HTML_EVENT_CLIENT_VIEW_POSTPASTE),
  CLIENT_VIEW_QUERYDRAGDROP(RichTextConstants.HTML_EVENT_CLIENT_VIEW_QUERYDRAGDROP),
  CLIENT_VIEW_POSTDRAGDROP(RichTextConstants.HTML_EVENT_CLIENT_VIEW_POSTDRAGDROP),
  CLIENT_VIEW_QUERYCLOSE(RichTextConstants.HTML_EVENT_CLIENT_VIEW_QUERYCLOSE),
  CLIENT_VIEW_QUERYENTRYRESIZE(RichTextConstants.HTML_EVENT_CLIENT_VIEW_QUERYENTRYRESIZE),
  CLIENT_VIEW_POSTENTRYRESIZE(RichTextConstants.HTML_EVENT_CLIENT_VIEW_POSTENTRYRESIZE),
  CLIENT_VIEW_INVIEWEDIT(RichTextConstants.HTML_EVENT_CLIENT_VIEW_INVIEWEDIT),
  CLIENT_VIEW_ONSELECT(RichTextConstants.HTML_EVENT_CLIENT_VIEW_ONSELECT),
