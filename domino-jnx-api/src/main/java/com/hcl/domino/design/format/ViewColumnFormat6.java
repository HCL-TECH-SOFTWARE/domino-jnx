...
public interface ViewColumnFormat6 extends ResizableMemoryStructure {
	...
	default ViewColumnFormat6 setAttributes(String attributes) {
	...
	default String getPublishFieldName() {
		return StructureSupport.extractStringValue(this,
			getAttributesLength(),
			getPublishFieldNameLength()
		);
	}
	default ViewColumnFormat6 setPublishFieldName(String name) {
		return StructureSupport.writeStringValue(
			this,
			getAttributesLength(),
			getPublishFieldNameLength(),
