...
public enum FileType {
	...
	public static Set<FileType> toFileTypes(int bitMask) {
	...
	public static short toBitMask(Collection<FileType> noteClassSet) {
		int result = 0;
	...
	public static int toBitMaskInt(Collection<FileType> noteClassSet) {
		int result = 0;
		if (noteClassSet!=null) {
			for (FileType currFind : values()) {
				if (noteClassSet.contains(currFind)) {
