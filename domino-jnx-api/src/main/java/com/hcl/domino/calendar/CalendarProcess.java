...
public enum CalendarProcess {
	...
	DELEGATE(0x00000010),
	/** Counter to a new time (requires populating {@link CalendarActionData#withChangeToStart} / {@link CalendarActionData#withChangeToEnd} values) */
	COUNTER(0x00000020),
	 ...
	 * those users specified in lists contained in the {@link CalendarActionData#withAddNamesRequired(String...)} etc. and 
