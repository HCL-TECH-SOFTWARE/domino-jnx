...
public interface Acl {
   ...
   *
   * @param name        user or group to be added, either in abbreviated or
   *                    canonical format
  ...
  /**
   * Adds a role to the ACL. If the role is already in the ACL, the method does
   * nothing.
   *
   ...
   *
   * @return ACL entries hashed by their username in the order they got returned
   *         from the C API
   */
   ...
   *
   * @param name name
   * @return an {@link Optional} describing the ACL entry, or an empty one if not
   *         found
   */
   ...
   * <br>
   * Unless the user's name is specified to be modified, the information that is
   * not specified to be
   * modified remains intact.<br>
   * <br>
   * If the user's name is specified to be modified, the user entry is deleted and
   * a new entry is created.<br>
   * Unless the other access control information is specified to be modified as
   * well, the other access control
