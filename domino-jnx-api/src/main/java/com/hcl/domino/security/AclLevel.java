 ...
 * Domino database.
 * Note: Currently the values associated with each enum are the same values used
 * by the Notes client. If these
 * values need to be changed, a mapping has to be introduced in the JNA
 * implementation connecting with the Notes C-API.
 *
